...
class ScriptForge(object, metaclass=_Singleton):
    ...
    def InvokeBasicService(
        ...
        Returns:
            tuple | list: The invoked Basic counterpart script (with InvokeSimpleScript()) will return a tuple
...
class SFServices:
    ...
    flgHardCode = Literal[4096]
    """Force hardcoded call to method, avoid CallByName()"""
    # Basic class type
...
class SFScriptForge:
    ...
    class SF_Basic(SFServices, metaclass=_Singleton):
        ...
        def CDateFromUnoDateTime(
            ...
            Returns:
                datetime | object: the equivalent datetime.datetime
        ...
        def DateAdd(
            ...
            Args:
                ...
                date (float | time.struct_time | datetime.datetime | datetime.date | datetime.time): A given
        ...
        def DatePart(
            ...
            Args:
                ...
                date (time.struct_time | datetime.datetime | datetime.date | datetime.time | str): The date from which to extract a part
        ...
        def DateValue(cls, string: str) -> datetime.datetime | Any:
            ...
            Returns:
                datetime.datetime | object: The converted date
    ...
    class SF_Region(SFServices, metaclass=_Singleton):
        ...
        def Country(self, region: str = ...) -> str:
            ...
            Returns:
                str: country name in English corresponding to a given region.
            """
            ...
        ...
        def DatePatterns(self, region=...) -> List[str]:
            ...
            Returns:
                List[str]: a zero-based array of strings containing the date acceptance patterns for the specified region.
            """
            ...
        def DateSeparator(self, region: str = ...) -> str:
            ...
            Returns:
                str: the date separator used in the given region.
            """
            ...
        def DayAbbrevNames(self, region: str = ...) -> List[str]:
            """
            Gets a zero-based array of strings containing the list of abbreviated weekday names in the specified language.

            Args:
                region (str, optional): region

            Returns:
                List[str]: a zero-based array of strings containing the list of abbreviated weekday names in the specified language.
            """
            ...
        def DayNames(self, region: str = ...) -> List[str]:
            """
            Gets a zero-based array of strings containing the list of weekday names in the specified language.

            Args:
                region (str, optional): region
            Returns:
                List[str]: a zero-based array of strings containing the list of weekday names in the specified language.
            """
            ...
        def DayNarrowNames(self, region: str = ...) -> List[str]:
            """
            Gets a zero-based array of strings containing the list of the initials of weekday names in the specified language.

            Args:
                region (str, optional): region

            Returns:
                List[str]: a zero-based array of strings containing the list of the initials of weekday names in the specified language.
            """
            ...
        def DecimalPoint(self, region: str = ...) -> str:
            ...
            Returns:
                str: Returns the decimal separator used in numbers in the specified region.
            """
            ...
        def Language(self, region: str = ...) -> str:
            ...
            Returns:
                str: the decimal separator used in numbers in the specified region.
            """
            ...
        def ListSeparator(self, region: str = ...) -> str:
            ...
            Returns:
                str: the list separator used in the specified region.
            """
            ...
        def MonthAbbrevNames(self, region: str = ...) -> List[str]:
            """
            Gets a zero-based array of strings containing the list of abbreviated month names in the specified language.

            Args:
                region (str, optional): region

            Returns:
                List[str]: a zero-based array of strings containing the list of abbreviated month names in the specified language.
            """
            ...
        def MonthNames(self, region: str = ...) -> List[str]:
            """
            Gets a zero-based array of strings containing the list of month names in the specified language.

            Args:
                region (str, optional): region

            Returns:
                List[str]: a zero-based array of strings containing the list of month names in the specified language.
            """
            ...
        def MonthNarrowNames(self, region: str = ...) -> List[str]:
            """
            Gets a zero-based array of strings containing the list of the initials of month names in the specified language.

            Args:
                region (str, optional): region

            Returns:
                List[str]: a zero-based array of strings containing the list of the initials of month names in the specified language.
            """
            ...
        def ThousandSeparator(self, region: str = ...) -> str:
            ...
            Returns:
                str: the thousands separator used in numbers in the specified region.
            """
            ...
        def TimeSeparator(self, region: str = ...) -> str:
            ...
            Returns:
                str: the separator used to format times in the specified region.
            """
            ...
        # Usual methods
        def DSTOffset(
            ...
            Args:
                localdatetime (datetime.datetime): the local date and time expressed as a date.
                timezone (str): the timezone for which the offset will be calculated.
                locale (str, optional): the locale specifying the country for which the offset will be calculated,
                    given either in "la-CO" or "CO" formats. The default value is the locale defined in the OfficeLocale property of the Platform service.
        ...
        def LocalDateTime(
            ...
            Args:
                utcdatetime (datetime.datetime): the UTC date and time, expressed using a date object.
                timezone (str): the timezone for which the local time will be calculated.
                locale (str, optional): the locale specifying the country for which the offset will be calculated,
                    given either in "la-CO" or "CO" formats. The default value is the locale defined in the OfficeLocale property of the Platform service.

            Returns:
                datetime.datetime: Computed local date and time
            """
            ...
        def Number2Text(self, number: Any, locale: str = ...) -> str:
            """
            Converts numbers and monetary values into written text for any of the currently supported languages.

            Args:
                number (Any): the number to be converted into written text.
                    ...
                    It is also possible to include ISO 4217 currency codes. See examples below for more information.
                locale (str, optional): the locale defining the language into which the number will be converted to,
                    given either in "la-CO" or "la" formats.
                    The default value is the locale defined in the OfficeLocale property of the Platform service.

            Returns:
                str: Converted number or monetary value.
            """
            ...
        def TimeZoneOffset(self, timezone: str, locale: str = ...) -> int:
            ...
            Args:
                timezone (str): the timezone for which the offset to the GMT will be calculated.
                locale (str, optional): the locale specifying the country for which the offset will be calculated, given either in "la-CO" or "CO" formats.
                    The default value is the locale defined in the OfficeLocale property of the Platform service.
        ...
        def UTCDateTime(
            ...
            Args:
                localdatetime (datetime.datetime): the local date and time in a specific timezone expressed as a date.
                timezone (str): the timezone for which the localdatetime argument was given.
                locale (str, optional): the locale specifying the country for which the localdatetime argument was given, expressed either in "la-CO" or "CO" formats.
                    The default value is the locale defined in the OfficeLocale property of the Platform service.
            Returns:
                datetime.datetime: the UTC date and time considering a given local date and time in a timezone.
            """
            ...
        def UTCNow(self, timezone: str, locale: str = ...) -> datetime.datetime:
            """
            Gets the current UTC date and time, given a timezone and locale.

            Args:
                timezone (str): the timezone for which the current UTC time will be calculated.
                locale (str, optional): the locale specifying the country for which the current UTC time will be calculated, given either in "la-CO" or "CO" formats.
                    The default value is the locale defined in the OfficeLocale property of the Platform service.
            ...
            Returns:
                datetime.datetime: the current UTC date and time, given a timezone and locale.
            """
            ...
    ...
    class SF_UI(SFServices, metaclass=_Singleton):
        ...
        def RunCommand(self, command: str, *args: Any, **kwargs: Any) -> None:
            ...
            Args:
                command (str): Case-sensitive string containing the UNO command name.
                    The inclusion of the prefix ".uno:" in the command is optional.
                    The command itself is not checked for correctness.
                    If nothing happens after the command call, then the command is probably wrong.
            """
            ...
...
class SFDatabases:
    ...
    class SF_Database(SFServices):
        ...
        def OpenFormDocument(
            ...
            Args:
                formdocument (str): a valid form document name as a case-sensitive string
                    When hierarchical, the hierarchy must be rendered with forward slashes ("/")

            Returns:
                SFDocuments.SF_FormDocument | None: A FormDocument instance or Nothing
            """
            ...
    ...
    class SF_Datasheet(SFServices):
        ...
        def RemoveMenu(self, menuheader: str) -> bool:
            ...
            """
            ...
        def Toolbars(self, toolbarname: str = ...) -> Any:
            """
            Returns either a list of the available toolbar names in the actual document or a Toolbar object instance.

            Args:
                toolbarname (str, optional):  the usual name of one of the available toolbars

            Returns:
                Any: A zero-based array of toolbar names when the argument is absent, or a new Toolbar object instance from the SF_Widgets library.
            """
            ...
        # endregion Methods
...
class SFDialogs:
    ...
    class SF_Dialog(SFServices):
        ...
        def Activate(self) -> bool:
            ...
            """
            ...
        def Center(self, parent: Any = ...) -> bool:
            """
            ...
            Args:
                parent (Any, optional): An optional object that can be either,
                    a ScriptForge dialog object, a ScriptForge document (Calc, Base, ...) object
            ...
            ...
        def CloneControl(
            self, sourcename: str, controlname: str, left: int = ..., top: int = ...
        ...
        def Controls(
            ...
            Returns:
                Tuple[str, ...] | SFDialogs.SF_DialogControl: A zero-base array of strings if ControlName is absent.
        ...
        def CreateButton(
            ...
            Args:
                ...
                toggle (bool, optional): when True a Toggle button is created. Default: ``False``
                push (str, optional): Button type "OK", "CANCEL" or empty string. Default: ``""``
            ...
            """
            # push (str, optional): 'OK', 'CANCEL' or '' default
            ...
        def CreateCheckBox(
            self, controlname: str, place: any, multiline: bool = ...
        ) -> SFDialogs.SF_DialogControl | None:
            """
            ...
            Args:
                controlname (str): the name of the new control. It must not exist yet
                place (Any): the size and position expressed in APPFONT units.
                multiline (bool, optional): When True (default = False), the caption may be displayed on more than one line
        ...
        def CreateComboBox(
            ...
            Args:
                ...
                dropdown (bool, optional): When True (default), a drop down button is displayed
                linecount (int, optional): Specifies the maximum line count displayed in the drop down. default is ``5``
        ...
        def CreateFixedLine(
            ...
            Args:
                controlname (str): the name of the new control. It must not exist yet
                place (Any): the size and position expressed in APPFONT units.
                orientation (str): Orientation kind, "H[orizontal]" or "V[ertical]".
        ...
        def CreateFixedText(
            ...
            Args:
                controlname (str): the name of the new control. It must not exist yet
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``NONE``
                multiline (bool, optional): When True the caption may be displayed on more than one line. Default ``False``
                align (str, optional): horizontal alignment, "LEFT" or "CENTER" or "RIGHT". Default 'LEFT'
                verticalalign (str, optional): vertical alignment, "TOP" or "MIDDLE" or "BOTTOM". Default ``TOP``
        ...
        def CreateHyperlink(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``NONE``
                multiline (bool, optional): _description_. Defaults to ....
                align (str, optional): horizontal alignment, "LEFT" or "CENTER" or "RIGHT". Default ``LEFT``
                verticalalign (str, optional): vertical alignment, "TOP" or "MIDDLE" or "BOTTOM". Default ``TOP``
        ...
        def CreateImageControl(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``3D``
                scale (str, optional): One of next values: "FITTOSIZE" "KEEPRATIO" or "NO". Default ``FITTOSIZE``
            Returns:
                SFDialogs.SF_DialogControl | None: an instance of the SF_DialogControl class or None
        ...
        def CreateListBox(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``3D``
                dropdown (bool, optional): When True, a drop down button is displayed. Default ``True``
                linecount (int, optional): Specifies the maximum line count displayed in the drop down, Default is ``5``
                multiselect (bool, optional): When True, multiple lines can be selected. Default is ``False``
            ...
            """
            ...
        def CreateNumericField(
            self,
            controlname: str,
            place: Any,
            border: Literal["3D", "FLAT", "NONE"] = ...,
            spinbutton: bool = ...,  # False
        ...
        def CreatePatternField(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``3D``
                editmask (str, optional): a character code that determines what the user may enter
                literalmask (str, optional): contains the initial values that are displayed in the pattern field
            ...
            See Also:
                More details on `Pattern Field, <https://wiki.documentfoundation.org/Documentation/DevGuide/Graphical_User_Interfaces#Pattern_Field>`__
            """
            ...
        def CreateProgressBar(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``3D``
                minvalue (int, optional): the smallest value that can be entered in the control. Default is ``0``
                maxvalue (int, optional): the largest value that can be entered in the control. Default is ``100``
        ...
        def CreateTableControl(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``3D``
                rowheaders (bool, optional): when True, the row headers are shown. Default is ``True``.
                columnheaders (bool, optional): when True, the column headers are shown. Default is ``True``.
                scrollbars (str, optional): H[orizontal] or V[ertical] or B[oth] or N[one] (default). Defaults to "None".
                gridlines (bool, optional): when True horizontal and vertical lines are painted between the grid cells. Default is ``False``.
        ...
        def CreateTextField(
            ...
            Args:
                ...
                place (Any): the size and position expressed in APPFONT units.
                border (str, optional): Border kind, "3D" or "FLAT" or "NONE". Default is ``3D``
                multiline (bool, optional): When True, the caption may be displayed on more than one line. Default is ``False``.
                maximumlength (int, optional): the maximum character count, ``0`` means unlimited. Defaults to ``0``.
                passwordcharacter (str, optional): a single character specifying the echo for a password text field . Defaults to "".
        ...
        def OrderTabs(
            ...
            Args:
                tabslist (Sequence[str]): an Sequence of valid control names in the order of tabulation
                start (int, optional): the tab index to be assigned to the 1st control in the list. Default is ``1``
                increment (int, optional): the difference between ``2`` successive tab indexes. Default is ``1``
        ...
        def Resize(
            ...
            Args:
                left (int, optional): the horizontal distance from the top-left corner
                top (int, optional): the vertical distance from the top-left corner
                width (int, optional): the width of the rectangle containing the dialog
                height (int, optional): the height of the rectangle containing the dialogue box
    ...
    class SF_NewDialog(SFServices):
        ...
        @classmethod
        def ReviewServiceArgs(cls, dialogname: str = ..., place: Any = ...) -> tuple:
            """
            Transform positional and keyword arguments into positional only
            Add the XComponentContext as last argument
            """
            ...
    # endregion SF_NewDialog CLASS
    ...
    class SF_DialogControl(SFServices):
        ...
        def Resize(
            ...
            Args:
                left (int, optional): the horizontal distance from the top-left corner. It may be negative.
                top (int, optional): the vertical distance from the top-left corner. It may be negative.
                width (int, optional): the horizontal width of the rectangle containing the Dialog. It must be positive.
                height (int, optional): the vertical height of the rectangle containing the Dialog. It must be positive.
        ...
        def SetTableData(
            ...
            Note:
                ``rowheaderwidth`` argument is ignored when the TableControl has no row header.
        ...
        @property
        def Border(self) -> Literal["3D", "FLAT", "NONE"]:
            """The Border property refers to the surrounding of the control: 3D, FLAT or NONE"""
            # TODO update this doc when the help becomes available online.
            # https://help.libreoffice.org/7.6/en-GB/text/sbasic/shared/03/sf_dialogcontrol.html?&DbPAR=SHARED
            ...
        @property
        ...
        @property
        def Width(self) -> int:
            """TThe Width property refers to the Width of the control"""
            # TODO update this doc when the help becomes available online.
            # https://help.libreoffice.org/7.6/en-GB/text/sbasic/shared/03/sf_dialogcontrol.html?&DbPAR=SHARED
            ...
        @property
...
class SFDocuments:
    ...
    class SF_Document(SFServices):
        ...
        def CreateMenu(
            ...
            Args:
                menuheader (str): The toplevel name of the new menu.
                before (Any, optional): The name (as a string) or position (as an integer starting at 1) of an existing menu before
                    which the new menu will be placed. If no value is defined for this argument,
                    the menu will be created at the last position in the menubar.
                submenuchar (str, optional): The delimiter used to create menu trees when calling methods as AddItem from the Menu service. The default value is ">".

            Returns:
                SFWidgets.SF_PopupMenu: menu
            """
            ...
        def Echo(self, echoon: bool = ..., hourglass: bool = ...) -> None:
            ...
            Args:
                echoon (bool, optional): when False, the display updates are suspended. Default is ``True``.
                hourglass (bool, optional): when True, the mouse pointer is changed to an hourglass. Default is ``False``.
        ...
        def RemoveMenu(self, menuheader: str) -> bool:
            ...
            Args:
                menuheader (str): The toplevel name of the menu to be removed.

            Returns:
                bool: True if the specified menu could be removed. If the specified menu does not exist, the method returns False.
            """
            ...
        ...
        def Toolbars(self, toolbarname: str = ...) -> Any:
            ...
            """
            # TODO update this doc when the help becomes available online.
            # https://help.libreoffice.org/7.6/en-GB/text/sbasic/shared/03/sf_document.html?&DbPAR=SHARED
            ...
        # endregion methods
        ...
        def IsDraw(self) -> bool:
            ...
            ...
        @property
        def IsFormDocument(self) -> bool:
            """
            Gets if instance is form document.
            """
            ...
        @property
    ...
    class SF_Calc(SF_Document, SFServices):
        ...
        def CompactLeft(
            ...
            Args:
                ...
                wholecolumn (bool, optional): If this option is set to True the entire column will be deleted from the sheet.
                    The default value is False, which means that the deleted column will be limited to the height of the specified range.
                filterformula (str, optional): The filter to be applied to each column to determine whether or not it will be deleted.
                    The filter is expressed as a Calc formula that should be applied to the first column.
                    When the formula returns True for a column, that column will be deleted.
                    The default filter deletes all empty columns.

            Returns:
                str: string with the range address of the compacted range. If all columns are deleted, then an empty string is returned.
            """
            ...
        def CompactUp(
            ...
            The deleted rows can be limited to the width of the specified range or span to the width of
            the entire sheet, thus deleting whole rows.
            ...
            Args:
                ...
                wholerow (bool, optional): If this option is set to True the entire row will be deleted from the sheet.
                    The default value is False, which means that the deleted row will be limited to the width of the specified range.
                filterformula (str, optional): The filter to be applied to each row to determine whether or not it will be deleted.
                    The filter is expressed as a Calc formula that should be applied to the first row.
                    When the formula returns True for a row, that row will be deleted.
                    The default filter deletes all empty rows.

            Returns:
                str: a string with the range address of the compacted range. If all rows are deleted, then an empty string is returned.
            """
            ...
        @overload
        ...
        def CreatePivotTable(
            ...
            rowfields: List[str] | str = ...,
            columnfields: List[str] | str = ...,
            filterbutton: bool = ...,
            rowtotals: bool = ...,
            columntotals: bool = ...,
        ) -> str:
            ...
            If a pivot table with the same name already exists in the targeted sheet, it will be replaced without warning.

            Args:
                pivottablename (str): The user-defined name of the new pivot table.
                sourcerange (str): The range containing the raw data, as a string.
                    It is assumed that the first row contains the field names that are used by the pivot table.
                targetcell (str): The top-left cell where the new pivot table will be placed.
                    If a range is specified, only its top-left cell is considered.
                datafields (List[str] | str, optional): It can be either a single string or an array containing strings
                    that define field names and functions to be applied.
                    When an array is specified, it must follow the syntax Array("FieldName[;Function]", ...).
                    ...
                    When all values are numerical, Sum is the default function, otherwise the default function is Count.
                rowfields (List[str] | str, optional): A single string or an array with the field names that will be used as the pivot table rows.
                columnfields (List[str] | str, optional): A single string or an array with the field names that will be used as the pivot table columns.
                filterbutton (bool, optional): Determines whether a filter button will be displayed above the pivot table (Default = True).
                rowtotals (bool, optional): Specifies if a separate column for row totals will be added to the pivot table (Default = True).
                columntotals (bool, optional): Specifies if a separate row for column totals will be added to the pivot table (Default = True)
        ...
        def ExportRangeToFile(
            ...
            Args:
                range (str): A sheet name or a cell range to be exported, as a string.
                filename (str): The name of the file to be saved. It must follow the SF_FileSystem. FileNaming notation.
                imagetype (str, optional): Identifies the destination file type. Possible values are "jpeg", "pdf" and "png". Defaults to "pdf"
                overwrite (bool, optional): When set to True, the destination file may be overwritten. Defaults to False

            Returns:
                bool: True if the destination file was successfully saved.
            """
            ...
        @overload
    ...
    class SF_FormDocument(SF_Document, SFServices):
        ...
        def CloseDocument(self) -> bool:
            ...
            Returns:
                bool: True if closure is successful; Otherwise, False.
            """
            ...
        def Forms(self, form: str | int = ...) -> SFDocuments.SF_Form | Sequence[str]:
            """
            Return either:
            ...
            Args:
                form (str, int, optional): a form stored in the document given by its name or its index.
        ...
        def PrintOut(
            ...
            Args:
                pages (str, optional): the pages to print as a string, like in the user interface. Example: "1-4;10;15-18". Defaults to all pages.
                copies (int, optional):  the number of copies to print. Defaults to 1.
                printbackground (bool, optional): print the background image when True. Default is ``True``.
                printblankpages (bool, optional): when False, omit empty pages. Default is ``False``.
                printevenpages (bool, optional): print the left pages when True. Default is ``True``.
                printoddpages (bool, optional): print the right pages when True. Defaults is ``True``.
                printimages (bool, optional): print the graphic objects when True. Default is ``True``.

            Returns:
                bool: True when successful; Otherwise, False.
            """
            ...
    # endregion SF_FormDocument CLASS
...
class SFWidgets:
    ...
    class SF_Menu(SFServices):
        ...
        def AddCheckBox(
            ...
            Args:
                menuitem (str): Defines the text to be displayed in the menu.
                    This argument also defines the hierarchy of the item inside the menu by using the submenu character.
                name (str, optional): String value used to identify the menu item.
                    By default, the last component of the menu hierarchy is used.
                status (bool, optional): Defines whether the item is selected when the menu is created. Defaults to False
                icon (str, optional): Path and name of the icon to be displayed without the leading path separator.
                    The actual icon shown depends on the icon set being used.
                tooltip (str, optional): Text to be displayed as tooltip.
                command (str, optional): The name of a UNO command without the .uno: prefix. If the command name does not exist, nothing happens.
                script (str, optional): The URI for a Basic or Python script that will be executed when the item is clicked.
        ...
        def AddItem(
            ...
            Args:
                ...
                icon (str, optional): Path and name of the icon to be displayed without the leading path separator.
                    The actual icon shown depends on the icon set being used.
                tooltip (str, optional): Text to be displayed as tooltip.
                command (str, optional): The name of a UNO command without the .uno: prefix.
                    If the command name does not exist, nothing happens.
                script (str, optional): The URI for a Basic or Python script that will be executed when the item is clicked.
        ...
        def AddRadioButton(
            ...
            Args:
                menuitem (str): Defines the text to be displayed in the menu. This argument also defines the hierarchy of the item inside the menu by using the submenu character.
                name (str, optional): String value to be returned when the item is clicked. By default, the last component of the menu hierarchy is used.
                status (bool, optional): Defines whether the item is selected when the menu is created. Defaults to False
                icon (str, optional): Path and name of the icon to be displayed without the leading path separator. The actual icon shown depends on the icon set being used.
                tooltip (str, optional): Text to be displayed as tooltip.
                command (str, optional): The name of a UNO command without the .uno: prefix. If the command name does not exist, nothing happens.
                script (str, optional): The URI for a Basic or Python script that will be executed when the item is clicked.
    ...
    class SF_Toolbar(SFServices):
        ...
        def ToolbarButtons(
            ...
            Args:
                buttonname (str, optional): the usual name of one of the available buttons in the actual toolbar. Defaults to "".

            Returns:
                SFWidgets.SF_ToolbarButton | Sequence[str]: A zero-based array of button names when the argument is absent, or a new SF_ToolbarButton object instance.
            """
            ...
    # endregion SF_Toolbar class

    # region SF_ToolbarButton
    class SF_ToolbarButton(SFServices):
        ...
        def Execute(self) -> Any:
            ...
            Returns:
                Any: The output of the script or None
            """
            ...
    # endregion SF_ToolbarButton
...
def CreateScriptService(
    service: Literal["Array", "array", "ScriptForge.Array"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["Basic", "basic", "ScriptForge.Basic"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["Dictionary", "dictionary", "ScriptForge.Dictionary"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["Exception", "exception", "ScriptForge.Exception"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["FileSystem", "filesystem", "ScriptForge.FileSystem"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["L10N", "l10n", "ScriptForge.L10N"], *args: Any, **kwargs: Any
) -> SFScriptForge.SF_L10N: ...
@overload
def createscriptservice(
    service: Literal["L10N", "l10n", "ScriptForge.L10N"], *args: Any, **kwargs: Any
) -> SFScriptForge.SF_L10N: ...
...
@overload
def CreateScriptService(
    service: Literal["Platform", "platform", "ScriptForge.Platform"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["Region", "region", "ScriptForge.Region"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["Session", "session", "ScriptForge.Session"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["String", "string", "ScriptForge.String"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["ScriptForge.TextStream"], *args: Any, **kwargs: Any
) -> SFScriptForge.SF_TextStream: ...
@overload
def createscriptservice(
    service: Literal["ScriptForge.TextStream"], *args: Any, **kwargs: Any
...
#   endregion SF_TextStream

#   region SF_Timer
@overload
def CreateScriptService(
    service: Literal["Timer", "timer", "ScriptForge.Timer"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["UI", "ui", "ScriptForge.UI"], *args: Any, **kwargs: Any
) -> SFScriptForge.SF_UI: ...
@overload
def createscriptservice(
    service: Literal["UI", "ui", "ScriptForge.UI"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["Database", "database", "SFDatabases.Database"],
    *args: Any,
    **kwargs: Any,
) -> SFDatabases.SF_Database: ...
@overload
...
@overload
def CreateScriptService(
    service: Literal["Datasheet", "datasheet", "SFDatabases.Datasheet"],
    *args: Any,
    **kwargs: Any,
...
@overload
def CreateScriptService(
    service: Literal["Dialog", "dialog", "SFDialogs.Dialog"], *args: Any, **kwargs: Any
) -> SFDialogs.SF_Dialog: ...
@overload
def createscriptservice(
    service: Literal["Dialog", "dialog", "SFDialogs.Dialog"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["SFDialogs.DialogControl"], *args: Any, **kwargs: Any
...
#   endregion SF_DialogControl

#   region SF_Document
@overload
def CreateScriptService(
    service: Literal["Document", "document", "SFDocuments.Document"],
    *args: Any,
    **kwargs: Any,
) -> SFDocuments.SF_Document: ...
@overload
...
@overload
def CreateScriptService(
    service: Literal["Base", "base", "SFDocuments.Base"], *args: Any, **kwargs: Any
) -> SFDocuments.SF_Base: ...
@overload
def createscriptservice(
    service: Literal["Base", "base", "SFDocuments.Base"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["Calc", "calc", "SFDocuments.Calc"], *args: Any, **kwargs: Any
) -> SFDocuments.SF_Calc: ...
@overload
def createscriptservice(
    service: Literal["Calc", "calc", "SFDocuments.Calc"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["SFDocuments.CalcReference"], *args: Any, **kwargs: Any
) -> SFDocuments.SF_CalcReference: ...
@overload
def createscriptservice(
    service: Literal["SFDocuments.CalcReference"], *args: Any, **kwargs: Any
) -> SFDocuments.SF_CalcReference: ...
...
#   region SF_FormControl
@overload
def CreateScriptService(
    service: Literal["SFDocuments.FormControl"], *args: Any, **kwargs: Any
...
#   endregion SF_FormControl

#   region SF_Writer
@overload
def CreateScriptService(
    service: Literal["Writer", "writer", "SFDocuments.Writer"],
    *args: Any,
    **kwargs: Any,
) -> SFDocuments.SF_Writer: ...
@overload
...
@overload
def CreateScriptService(
    service: Literal["Menu", "menu", "SFWidgets.Menu"], *args: Any, **kwargs: Any
) -> SFWidgets.SF_Menu: ...
@overload
def createscriptservice(
    service: Literal["Menu", "menu", "SFWidgets.Menu"], *args: Any, **kwargs: Any
...
@overload
def CreateScriptService(
    service: Literal["PopupMenu", "popupmenu", "SFWidgets.PopupMenu"],
    *args: Any,
    **kwargs: Any,
